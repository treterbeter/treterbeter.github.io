...
const colors = {
    ...
    tb_gradient: "linear-gradient(90deg, rgb(35, 206, 227), rgb(5, 245, 195))",
}
...
entries.push(new Entry("Den Weg der Champions betreten oder auch nicht", "Rocket League", 1, new EntryTime(19, 0), 150, true, colors.tb_gradient));
entries.push(new Entry("Fullsquad Mittwoch", "Fortnite", 2, new EntryTime(19, 0), 120, true, colors.tb_gradient));
entries.push(new Entry("LOL - Leid oder Liebe", "League of Legends", 3, new EntryTime(15, 0), 180, false, colors.tb_gradient));
entries.push(new Entry("FIFA gamen ohne Sinn und Verstand", "FIFA 22", 6, new EntryTime(17, 0), 150, false, colors.tb_gradient));
